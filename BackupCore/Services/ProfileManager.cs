...
{
    private static readonly string _appDataFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "BackupSchedulerApp");
    private static readonly string _profilesFilePath = Path.Combine(_appDataFolder, "profiles.json");

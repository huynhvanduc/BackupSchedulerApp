...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        string workerLogFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "BackupSchedulerApp", "Worker_Fallback_log.txt");
